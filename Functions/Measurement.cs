...
namespace Solution.RuralWater.AZF.Functions
{
    public class Measurement
    {
        ...
        public Measurement(IOptions<AuthenticationOptions> authOptions, IOptions<Secrets> secrets, IQueryService queryService, AuthenticationHelper authenticationHelper, AuthorizationHelper authorizationHelper, ILoggerFactory loggerFactory)
        {
