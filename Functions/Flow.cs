...
namespace Solution.RuralWater.AZF.Functions
{
    public class Flow
    {
        ...
        public Flow(IOptions<AuthenticationOptions> authOptions, IOptions<Secrets> secrets, IQueryService queryService, AuthenticationHelper authenticationHelper, AuthorizationHelper authorizationHelper, ILoggerFactory loggerFactory)
        {
            ...
            _logger = loggerFactory.CreateLogger<Flow>();
        }
