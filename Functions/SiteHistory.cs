...
//     {
//         [Function("Raw")]
//         public static async Task<IActionResult> GetRaw(
//             [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "data/site-history/raw")] HttpRequest req,
...
//         [Function("Latest")]
//         public static async Task<IActionResult> GetLatest(
//             [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "data/site-history/latest")] HttpRequest req,
//             FunctionContext executionContext)
//         {
//             var logger = executionContext.GetLogger("Raw");
